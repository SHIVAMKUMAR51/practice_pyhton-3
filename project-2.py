...
for page_num in range[1, page_num_MAX]:
    ...
    for hotel in all_hotels:
        ...
        hotel_dict["address"]=hotel.find("span", {"itemprop": "streetAddress"}).txt
        hotel_dict["price"]=hotel.find("span", {"class": "listingPrice_finalPrice"}).txt
        #try....except
        try:
            hotel_dict["rating"]=hotel.find("span",{"class": "hotelRating_ratingSummary"}).txt
